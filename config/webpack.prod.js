...
module.exports = {
    entry: {
        ...
        tag: [path.join(__dirname, '../src/public/scripts/tag.es')]
    },
    output: {
        filename: 'public/scripts/[name]-[hash:5].js',
        path: path.join(__dirname, '../build/'),
        publicPath:'http://202.192.134.6:3000/'
    },
    module: {
        rules: [
            {
    ...
    plugins: [
        ...
        new webpack
            .optimize
            .CommonsChunkPlugin({name: 'vendor', filename: 'public/scripts/common/vendor-[hash:5].min.js'}),
